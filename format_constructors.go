...
func (o *Output) Itemf(format string, args ...any) *ItemHandle {
...
func (o *Output) Taskf(format string, args ...any) *TaskHandle {
...
func (g *Tasks) Taskf(format string, args ...any) *TaskHandle {
