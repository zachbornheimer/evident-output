...
| **MCP install (module)** | `GOBIN=$HOME/.local/bin go install github.com/zachbornheimer/evident-output/cmd/evident-output-mcp@v0.2.4` |
...
2. **Standalone CLI** — `go run github.com/zachbornheimer/evident-output/cmd/evident-output@v0.2.4 …`  
...
```bash
go run github.com/zachbornheimer/evident-output/cmd/evident-output@v0.2.4 review ./path.go
```
